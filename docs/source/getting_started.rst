...
For example a non-relativistic coupled cluster singles doubles (CCSD) calculation using within pyscf interface spin-adapted implementation can be performed using the following input file,
